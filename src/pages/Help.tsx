  ...
  const categories = [
    ...
    },
    {
      ...
      faqs: [
        {
          question: '如何发布救援请求？',
          answer: '登录后点击"提交救援申请"，填写问题描述、技术栈标签、预算范围等信息。支付基础咨询费（¥49）后，您的请求将展示给平台专家。'
        },
        {
          question: '基础咨询费包含什么？',
          answer: '基础咨询费（¥49）包含：1）多位专家的初步问题诊断；2）详细的解决方案建议；3）预估的工作量和报价。如果专家无法提供有效诊断，费用将全额退还。'
        },
        {
          question: '如何选择合适的专家？',
    ...
    },
    {
      ...
      faqs: [
        ...
        {
          question: '平台服务费是多少？',
          answer: '平台收取服务费用的 10% 作为平台服务费。例如，如果您支付 ¥500 给专家，平台收取 ¥50，专家获得 ¥450。基础咨询费（¥49）不额外收取服务费。'
        }
      ]
    },
    {
